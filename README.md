...
## 📱 Ghost API (Mobile App)

Ghost exposes a single internal API on port **8766** for chat, history, memory, and remote control.

### 1. Add API settings to Ghost's `.env`
