...
# Refer to: https://wiki.ianclemence.com/hardware/en/maixcam/gpio.html
...
- https://wiki.ianclemence.com/hardware/en/kvm/NanoKVM/introduction.html
...
- Download devmem from the ianclemence package repository
