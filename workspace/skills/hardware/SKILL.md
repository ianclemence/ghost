---
name: hardware
description: Read and control I2C and SPI peripherals on ianclemence boards (LicheeRV Nano, MaixCAM, NanoKVM).
homepage: https://wiki.ianclemence.com/hardware/en/lichee/RV_Nano/1_intro.html
metadata:
  { "nanobot": { "emoji": "🔧", "requires": { "tools": ["i2c", "spi"] } } }
---
...
Most I2C/SPI pins are shared with WiFi on ianclemence boards. You must configure pinmux before use.
