...
compatibility: Requires curl and jq, plus HA_URL and HA_TOKEN environment variables. Network access to Home Assistant instance.
metadata: {"author": "anotb", "version": "2.1.0"}
---
