...
To reply non-interactively from Ghost, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from Ghost)** — pipe the message via stdin:
