...
var declarationRules = []declarationRule{
	...
	},
	{
		...
		re:        regexp.MustCompile(`(?i)\bmy favorite food is\s+([^;.,!?]+)`),
		likes:     true,
	},
	{
		name:      "favorite_drink",
		kind:      KindPreference,
		predicate: "preference/favorite_drink",
		re:        regexp.MustCompile(`(?i)\bmy favorite drink is\s+([^;.,!?]+)`),
		likes:     true,
	},
	{
		name:      "favorite_show",
		kind:      KindPreference,
		predicate: "preference/favorite_show",
		re:        regexp.MustCompile(`(?i)\bmy favorite (?:show|movie) is\s+([^;.,!?]+)`),
		likes:     true,
	},
	{
		name:      "favorite_book",
		kind:      KindPreference,
		predicate: "preference/favorite_book",
		re:        regexp.MustCompile(`(?i)\bmy favorite book is\s+([^;.,!?]+)`),
		likes:     true,
	},
	{
		name:      "favorite_song",
		kind:      KindPreference,
		predicate: "preference/favorite_song",
		re:        regexp.MustCompile(`(?i)\bmy favorite song is\s+([^;.,!?]+)`),
		likes:     true,
	},
	{
		name:      "favorite_place",
		kind:      KindPreference,
		predicate: "preference/favorite_place",
		re:        regexp.MustCompile(`(?i)\bmy favorite place is\s+([^;.,!?]+)`),
		likes:     true,
	},
	{
		name:      "goal",
	...
	},
	{
		...
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi want to launch\s+([^;.,!?]+)`),
		prefix:    "launch ",
	},
	{
		name:      "want_create",
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi want to create\s+([^;.,!?]+)`),
		prefix:    "create ",
	},
	{
		name:      "want_start",
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi want to start\s+([^;.,!?]+)`),
		prefix:    "start ",
	},
	{
		name:      "goal_launch",
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi(?:'d| would) like to launch\s+([^;.,!?]+)`),
		prefix:    "launch ",
	},
	{
		name:      "goal_build",
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi(?:'d| would) like to build\s+([^;.,!?]+)`),
		prefix:    "build ",
	},
	{
		name:      "plan_launch",
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi plan to launch\s+([^;.,!?]+)`),
		prefix:    "launch ",
	},
	{
		name:      "plan_build",
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi plan to build\s+([^;.,!?]+)`),
		prefix:    "build ",
	},
	{
		name:      "trying_to_launch",
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi(?:'m| am) trying to launch\s+([^;.,!?]+)`),
		prefix:    "launch ",
	},
	{
		name:      "trying_to_build",
		kind:      KindGoal,
		predicate: "goal/primary",
		re:        regexp.MustCompile(`(?i)\bi(?:'m| am) trying to build\s+([^;.,!?]+)`),
		prefix:    "build ",
	},
	{
		name:      "partner",
	...
	},
	{
		...
		re:        regexp.MustCompile(`(?i)\bi work with (\w+)\b`),
	},
	{
		name:      "work",
		kind:      KindFact,
	...
	},
	{
		...
		kind:      KindFact,
		predicate: "fact/work",
		re:        regexp.MustCompile(`(?i)\bi(?:'m| am) working on\s+([^;.,!?]+)`),
	},
	{
		name:      "working_on",
		kind:      KindFact,
		predicate: "fact/work",
		re:        regexp.MustCompile(`(?i)\bi(?:'m| am) currently working on\s+([^;.,!?]+)`),
	},
	{
		name:      "building",
		kind:      KindFact,
		predicate: "fact/work",
		re:        regexp.MustCompile(`(?i)\bi(?:'m| am) building\s+([^;.,!?]+)`),
	},
	{
		name:      "job",
		kind:      KindFact,
