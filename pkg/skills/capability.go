...
var capabilityRegistry = map[string]Capability{
	...
	"scraper":          {ID: "scraper.fetch", Skill: "internet-reading", RequiredInput: []string{"url"}, AllowedTools: []string{"read_file", "exec", "web_fetch"}, Primary: "jina reader", Fallback: "direct fetch", MaxAttempts: 2, Timeout: 15 * time.Second, NetworkRequired: true, Risk: "read_only"},
	"internet-reading": {ID: "scraper.fetch", Skill: "internet-reading", RequiredInput: []string{"url"}, AllowedTools: []string{"read_file", "exec", "web_fetch"}, Primary: "jina reader + yt-dlp + feedparser", Fallback: "direct fetch", MaxAttempts: 2, Timeout: 15 * time.Second, NetworkRequired: true, Risk: "read_only"},
	"email":            {ID: "email.read", Skill: "email", AllowedTools: []string{"email_search", "email_send", "read_file", "exec"}, Primary: "email_search/email_send tools (Gmail connected app)", Fallback: "himalaya via exec", MaxAttempts: 2, Timeout: 15 * time.Second, NetworkRequired: true, Risk: "consequential"},
	"spotify":          {ID: "media.playback", Skill: "spotify", AllowedTools: []string{"media_play", "read_file", "exec"}, Primary: "media_play tool (Spotify connected app)", Fallback: "spotify CLI via exec", MaxAttempts: 2, Timeout: 10 * time.Second, NetworkRequired: true, Risk: "low_risk"},
	"github":           {ID: "code.read", Skill: "github", AllowedTools: []string{"code_search", "read_file", "exec"}, Primary: "code_search tool (GitHub connected app)", Fallback: "gh CLI via exec", MaxAttempts: 2, Timeout: 10 * time.Second, NetworkRequired: true, Risk: "read_only"},
	"notion":           {ID: "docs", Skill: "notion", AllowedTools: []string{"docs_search", "read_file", "exec"}, Primary: "docs_search tool (Notion connected app)", Fallback: "none", MaxAttempts: 2, Timeout: 10 * time.Second, NetworkRequired: true, Risk: "read_only"},
